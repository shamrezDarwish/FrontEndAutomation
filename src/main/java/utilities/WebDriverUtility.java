...
public class WebDriverUtility extends Base {
	...
	public static void switchToFrameByID(String frameValue) {
		
		driver.switchTo().frame(frameValue);
	}
	
	public static void switchToFrameByWebElement(WebElement elemement) {
		
		driver.switchTo().frame(elemement);
	}
